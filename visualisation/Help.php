            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" onsubmit="return verifyForm()">
                        ...
                        <input type="text" class="form-control" id="lastName" placeholder="Nom" name="lastname" onblur="checkLastName()" required>
                        <p class="comment"><?php echo $lastnameError ?></p>
                        <label for="firstName">Prénom :</label>
                        <input type="text" class="form-control" id="firstName" placeholder="Prenom" name="firstname" onblur="checkFirstName()" required>
                        <p class="comment"><?php echo $firstnameError ?></p>
                        <label for="sexe">Sexe :</label>
                        <select class="col-md-12" name="genre" id="sexe">
